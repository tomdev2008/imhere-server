 ...
 **********************************************************************
 */
package org.xiaoxiancai.imhere.client.utils;
...
public class ClientConstant {
     ...
     * 处理器:客户端连接
     */
    public static final String HANDLER_CONNECTION = "connection-handler";
     ...
     * 解码器:添加好友
     */
    public static final String DECODER_ADD_FRIEND = "add-friend-decoder";
