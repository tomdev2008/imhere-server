...
// source: LoginResponseProtos.proto
...
public final class LoginResponseProtos {
  ...
  public interface LoginResponseOrBuilder extends
    ...
    /**
     * <code>repeated .org.xiaoxiancai.imhere.server.business.protos.AddFriendRequest addFriendRequest = 5;</code>
     */
  ...
  public static final class LoginResponse extends
    ...
    public static final int ADDFRIENDREQUEST_FIELD_NUMBER = 5;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < addFriendRequest_.size(); i++) {
        output.writeMessage(5, addFriendRequest_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < addFriendRequest_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, addFriendRequest_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\031LoginResponseProtos.proto\022-org.xiaoxia" +
      "ncai.imhere.server.business.protos\032\034AddF" +
      "riendRequestProtos.proto\"\236\001\n\rLoginRespon" +
      "se\022\021\n\tisSuccess\030\001 \002(\010\022\016\n\006status\030\002 \002(\005\022\017\n" +
      "\007message\030\003 \001(\t\022Y\n\020addFriendRequest\030\005 \003(\013" +
      "2?.org.xiaoxiancai.imhere.server.busines" +
      "s.protos.AddFriendRequestBD\n-org.xiaoxia" +
      "ncai.imhere.common.protos.businessB\023Logi" +
      "nResponseProtos"
    };
